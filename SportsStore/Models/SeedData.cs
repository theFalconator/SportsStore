        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product() { Name = "Human Chess Board", Description = "A fun game forthe family", Category = "Chess", Price = 75 },
                    new Product() { Name = "Unsteady Chair", Description = "Secretly give your oponent a disadvantage", Category = "Chess", Price = 29.95m },
